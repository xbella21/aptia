...
export default function Icfes() {
  ...
  const fields = [
    { name: 'scoreMath', label: 'Matemáticas' },
    { name: 'scoreReading', label: 'Lectura crítica' },
    { name: 'scoreSciences', label: 'Ciencias naturales' },
    { name: 'scoreSocial', label: 'Ciencias sociales' },
    { name: 'scoreEnglish', label: 'Inglés' },
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        ...
        <p style={styles.sub}>Ingresa tus puntajes por área</p>
        {error && <div style={styles.error}>{error}</div>}
        {success && (
          <div style={styles.successBox}>
            <p style={styles.successMsg}>✓ Puntajes guardados correctamente</p>
            <p style={styles.successSub}>Confirma tus puntajes para generar tu ranking de programas</p>
