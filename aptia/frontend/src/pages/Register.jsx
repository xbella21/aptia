    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          ...
          <p style={styles.tagline}>Orientacion vocacional inteligente</p>
        </div>
        <div style={styles.body}>
          ...
          <form onSubmit={submit}>
            ...
            <input style={styles.input} name="password" type="password" placeholder="Minimo 8 caracteres" value={form.password} onChange={handle} required />
            <button style={{ ...styles.btn, opacity: loading ? 0.7 : 1 }} type="submit" disabled={loading}>
              {loading ? 'Creando cuenta...' : 'Registrarse'}
            </button>
          </form>
          <p style={styles.linkText}>Ya tienes cuenta? <a href="/login" style={styles.link}>Inicia sesion</a></p>
        </div>
      </div>
    </div>
  );
...
const styles = {
  ...
  logo: { fontSize: '26px', fontWeight: '700', color: '#e8f5e3' },
