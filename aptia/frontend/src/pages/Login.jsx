    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.body}>
          ...
          <p style={styles.linkText}>No tienes cuenta? <a href="/register" style={styles.link}>Registrate</a></p>
        </div>
      </div>
    </div>
  );
...
const styles = {
  ...
  input: { width: '100%', background: 'var(--beige)', border: '0.5px solid var(--beige-border)', borderRadius: '8px', padding: '11
@"
import { useState } from 'react';
import { useNavigate, Link } from 'react-router-dom';
import { useAuth } from '../context/AuthContext';
